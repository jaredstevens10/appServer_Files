...
//include config
//uncomment below
//require_once('../JobTracker/includes/config.php');

//check if already logged in move to home page
//uncomment below

//if( $adminuser->is_logged_in() ){ header('Location: ../JobTracker/NewReviewTable.php'); } 
	...
	<div class="row">
	    ...
	    <div class="col-xs-12 col-sm-8 col-md-6 col-sm-offset-2 col-md-offset-3">
			<form role="form" method="post" action="" autocomplete="off">
				...
				<p><a href='../JobTracker/index.php'>Back to home page</a></p>
				<hr>

...
$Name = $idValue->name;
$GoldAmount = $idValue->goldAmount;
$StartUpgrade = $idValue->startUpgrade;
$EndUpgrade = $idValue->endUpgrade;
}


/*
{"data":[{"id":"NA","info":[{"location":[{"longitude":"NA","latitude":"NA"}],"name":"NA","goldAmount":"NA","level":"NA","status":"NA","startUpgrade":"NA","endUpgrade":"NA"}]}]}
*/



echo "{\"id\":\"$locationID\",\"latitude\":\"$PointLat\",\"longitude\":\"$PointLong\",\"altitude\":\"$PointAlt\",\"status\":\"$MissionStatus\",\"level\":\"$MissionLevel\",\"name\":\"$Name\",\"goldamount\":\"$GoldAmount\",\"startupgrade\":\"$StartUpgrade\",\"endupgrade\":\"$EndUpgrade\"},";

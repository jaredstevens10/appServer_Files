...
$AllMissionInfo[] = Array('location' => $LocationInfo, 'targetname' => $TargetName, 'targetID' => $TargetEmail, 'startTime' => $StartTime, 'endTime' => $EndTime, 'ownername' => $username, 'ownerID' => $email, 'level' => $Level, 'range' => $Range, 'status' => $Status);

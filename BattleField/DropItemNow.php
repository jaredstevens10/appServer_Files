...
$GetItem = "UPDATE GameItems SET username = '', isAvailable = 'yes', latitude = :lat, longitude = :long, altitude = :alt WHERE id = " . $itemID;
$sql_insert = $db->prepare($GetItem);
//$sql_insert->bindParam(":NewUser", $username);
$sql_insert->bindParam(":lat", $lat);
$sql_insert->bindParam(":long", $long);
$sql_insert->bindParam(":alt", $alt);
$sql_insert->execute();

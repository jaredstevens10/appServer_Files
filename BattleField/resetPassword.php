...
//if( $user->is_logged_in() ){ header('Location: ../Reviews/memberpage.php'); } 
...
if(isset($_POST['submit'])){
	...
	if(!isset($error)){
		...
		try {
			...
			$stmt = $db->prepare("UPDATE GeoHunters SET password = :hashedpassword, resetComplete = 'Yes'  WHERE resetToken = :token");
			$stmt->execute(array(
			...
			//header('Location: ../Reviews/login.php?action=resetAccount');
			exit;
